...
// TODO: remove height, width with classnames
const ButtonAddToSlack: FC<Props> = ({ height = 54, width = 180 }) => {
  return (
    <a
      ...
      className="inline-flex items-center justify-center no-underline font-semibold px-4 bg-white text-black rounded-lg"
      style={{ height, width }}
    >
      <svg
