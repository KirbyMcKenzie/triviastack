...
const TriviaGame = () => {
  ...
  return (
    <div className={lato.className} id="rewardId">
      <div className=" bg-white border-2 border-gray-100 max-w-[820px] mx-auto shadow-3xl text-left px-5 py-4 md:px-10 md:pt-8 md:pb-10 md:rounded-3xl duration-300 ease-in-out transition-all md:hover:scale-105">
